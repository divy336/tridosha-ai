...
const Report: React.FC = () => {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.text("AYURVEDIC DOSHA REPORT", pageWidth / 2, 30, {
        align: "center",
      });

      pdf.setFontSize(14);
      pdf.setFont("helvetica", "normal");
      pdf.text("Personalized Constitution Analysis", pageWidth / 2, 45, {
        align: "center",
      });
      ...
      const scoreColor = getColorRGB(
        getWellnessScoreColor(result.wellnessScore),
      );
      ...
      pdf.text("Wellness Score", pageWidth / 2, 150, {
        align: "center",
      });
      ...
      pdf.text(`${result.wellnessScore}/100`, pageWidth / 2, 165, {
        align: "center",
      });
      // Dosha Percentages
      pdf.setTextColor(0, 0, 0);
      ...
      pdf.rect(
        margin,
        yPos + 2,
        (contentWidth * result.percentages.vata) / 100,
        barHeight,
        "F",
      );
      yPos += barSpacing;
      ...
      pdf.rect(
        margin,
        yPos + 2,
        (contentWidth * result.percentages.pitta) / 100,
        barHeight,
        "F",
      );
      yPos += barSpacing;
      ...
      pdf.rect(
        margin,
        yPos + 2,
        (contentWidth * result.percentages.kapha) / 100,
        barHeight,
        "F",
      );
      ...
      pdf.text(
        "Ayurvedic Dosha Assessment System",
        pageWidth / 2,
        pageHeight - 10,
        { align: "center" },
      );
      ...
      pdf.setFont("helvetica", "normal");
      pdf.setTextColor(0, 0, 0);
      const physicalLines = pdf.splitTextToSize(
        result.physicalAnalysis,
        contentWidth,
      );
      ...
      pdf.setFont("helvetica", "normal");
      pdf.setTextColor(0, 0, 0);
      const emotionalLines = pdf.splitTextToSize(
      ...
      pdf.setFont("helvetica", "normal");
      pdf.setTextColor(0, 0, 0);
      const digestiveLines = pdf.splitTextToSize(
        result.digestiveAnalysis,
        contentWidth,
      );
      ...
      pdf.setFont("helvetica", "normal");
      pdf.setTextColor(0, 0, 0);
      const sleepLines = pdf.splitTextToSize(
      ...
      pdf.setFontSize(16);
      pdf.setFont("helvetica", "bold");
      pdf.text("DIETARY RECOMMENDATIONS", pageWidth / 2, 10, {
        align: "center",
      });
      ...
      pdf.setFontSize(16);
      pdf.setFont("helvetica", "bold");
      pdf.text("PERSONALIZED YOGA PRACTICE", pageWidth / 2, 10, {
        align: "center",
      });
      ...
      pdf.setFontSize(16);
      pdf.setFont("helvetica", "bold");
      pdf.text("LIFESTYLE & DAILY ROUTINES", pageWidth / 2, 10, {
        align: "center",
      });
      ...
      pdf.text(
        `Report Generated: ${formatDate(result.timestamp)}`,
        pageWidth / 2,
        pageHeight - 15,
        { align: "center" },
      );
        ...
        <div className="report-container" ref={reportRef}>
          ...
          <div
            style={{
              ...
              padding: "30px",
              border:
                "3px solid " + getWellnessScoreColor(result.wellnessScore),
              borderRadius: "10px",
              marginBottom: "30px",

              backgroundColor:
                getWellnessScoreColor(result.wellnessScore) + "25",
            }}
          >
            <h2
              style={{
            ...
            <div
              style={{
                ...
                textShadow: "rgb(0 0 0 / 66%) 2px 2px 1px",
              }}
            >
            ...
            >
              ...
              {result.wellnessScore >= 60 &&
                ...
                "Good Balance - Minor Adjustments Needed"}
              {result.wellnessScore >= 40 &&
                result.wellnessScore < 60 &&
                "Moderate Imbalance - Follow Recommendations"}
              {result.wellnessScore < 40 &&
                "Significant Imbalance - Prioritize Lifestyle Changes"}
            </p>
          </div>
          ...
          <div
            style={{
              border:
                "2px solid" + (getDoshaColor(result.dominantDosha) + "50"),
              borderRadius: "8px",
              padding: "30px",
              marginBottom: "30px",
              backgroundColor: getDoshaColor(result.dominantDosha) + "40",
            }}
          >
            <h2
              className="dosha-title"
              style={{ color: getDoshaColor(result.dominantDosha) + "90" }}
            >
            ...
            >
              <h3 style={{ marginBottom: "1px" }}>Constitution Type:</h3>
              <div
                style={{
                  fontSize: "24px",
                  fontWeight: "bold",
              ...
              <div style={{ marginTop: "1px" }}>
                ...
                <span
                  style={{
                    color: getDoshaColor(result.secondaryDosha),
                    fontSize: "18px",
                    fontWeight: "bold",
                  }}
                >
            ...
            {/* Dosha Percentages */}
            <div style={{ marginTop: "25px", fontFamily: "monospace" }}>
              <h3 style={{ fontSize: "20px" }}>Dosha Distribution</h3>
          ...
          {/* Detailed Analyses */}
          <div
            style={{ marginBottom: "30px", fontFamily: "Arial, sans-serif" }}
          >
            ...
            >
              <h3 style={{ marginTop: "0", color: "#303F9F" }}>
                Sleep Patterns
              </h3>
              <p style={{ lineHeight: "1.8", margin: "0" }}>
                {result.sleepAnalysis}
          ...
          >
            ...
            >
              ...
              >
                <h3 style={{ marginTop: "0", color: "#558B2F" }}>
                  Recommended Herbs
                </h3>
                <ul style={{ paddingLeft: "20px", lineHeight: "1.8" }}>
              ...
              >
                <h3 style={{ marginTop: "0", color: "#00838F" }}>
                  Recommended Drinks
                </h3>
                <ul style={{ paddingLeft: "20px", lineHeight: "1.8" }}>
          ...
          >
            <strong>Medical Disclaimer:</strong> This assessment is for
            educational and informational purposes only and should not be
            considered medical advice. The recommendations provided are based on
            traditional Ayurvedic principles and are not intended to diagnose,
            treat, cure, or prevent any disease. Always consult with a qualified
            healthcare provider or certified Ayurvedic practitioner before
            making significant changes to your diet, lifestyle, or health
            regimen, especially if you have existing health conditions or are
            taking medications.
          </div>
        </div>
      </div>
