  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [usersRes, assessmentsRes, allAssessmentsRes] = await Promise.all([
        axios.get("https://tridosha-ai.onrender.com/api/assessment/get_total_user"),
        axios.get("https://tridosha-ai.onrender.com/api/assessment/get_total_assessment"),
        axios.get("https://tridosha-ai.onrender.com/api/assessment/get_all_assessments"),
      ]);
  ...
  const handleViewAssessment = async (id: number) => {
    try {
      ...
      const res = await axios.get(
        `https://tridosha-ai.onrender.com/api/assessment/details/${id}`
      );
