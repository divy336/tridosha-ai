...
def calculate_advanced_dosha_scores(answers, symptoms):
    """
    Advanced weighted dosha scoring system
    Uses question-specific weights for more accurate assessment
    """
    scores = {
        'vata': 0.0,
        'pitta': 0.0,
    ...
    # Question weights (some questions are more indicative than others)
    question_weights = {
        'bodyFrame': 1.5,
        'skinType': 1.3,
        'hairType': 1.0,
    ...
    # Process each answer with weights
    ...
    for symptom in symptoms:
        if symptom in symptom_influences:
            influences = symptom_influences[symptom]
            for dosha, impact in influences.items():
                scores[dosha] += impact
...
def analyze_constitution(percentages):
    """
    Determine constitution type based on dosha percentages
    Handles single, dual, and tridoshic constitutions
    """
    ...
    # Tridoshic (all balanced within 15%)
...
def generate_dynamic_recommendations(percentages, constitution, symptoms):
    ...
    # EXTREME VATA (>60%)
    if vata > 60:
        recommendations['physical_analysis'] = "Your constitution shows extreme Vata dominance, indicating significant nervous system imbalance. You may experience pronounced dryness, coldness, irregular digestion, and variable energy levels. Your body craves warmth, stability, and grounding. Joint crackling, cold extremities, and thin build are common manifestations."
        
        recommendations['emotional_analysis'] = "High Vata creates mental restlessness, racing thoughts, anxiety, fear, and overwhelm. You may struggle with focus, experience worry about the future, and feel scattered or ungrounded. Creative but easily overstimulated. Need practices that calm the nervous system."
        
        recommendations['digestive_analysis'] = "Irregular appetite with tendency toward gas, bloating, constipation, and dry digestion. Your digestive fire (Agni) is erratic - sometimes strong, sometimes weak. You need warm, moist, well-cooked foods eaten at regular times to stabilize digestion."
        
        recommendations['sleep_analysis'] = "Light, interrupted sleep with difficulty falling asleep and staying asleep. You wake easily from noise or thoughts. May experience insomnia, especially between 2-6 AM (Vata time). Need calming bedtime routine and nervous system support."
        ...
        recommendations['foods_prefer'] = [
            ...
            'Rice and quinoa',
            'Nuts soaked overnight (almonds, walnuts)',
            'Warm herbal teas',
            'Cooked greens with oil'
        ]
        ...
        recommendations['herbs'] = [
            'Ashwagandha - nervous system support and grounding',
            'Brahmi - calms mind and improves focus',
        ...
        recommendations['yoga'] = [
            {
                ...
                'benefit': 'Calms nervous system and reduces anxiety',
                'energy': 'Deeply grounding and soothing',
                'imagePath': '/images/yoga/balasana.jpg'
            },
            {
                'name': 'Tadasana (Mountain Pose)',
                'description': 'Standing foundation pose',
                'benefit': 'Grounds energy into earth, improves stability',
                'energy': 'Centering and stabilizing',
                'imagePath': '/images/yoga/tadasana.jpg'
            },
            {
                'name': 'Viparita Karani (Legs Up Wall)',
                'description': 'Gentle inversion',
                'benefit': 'Reverses downward flow of Vata, deeply calming',
                'energy': 'Restorative and peaceful',
                'imagePath': '/images/yoga/viparita-karani.jpg'
            },
            {
                'name': 'Paschimottanasana (Seated Forward Bend)',
                'description': 'Calming forward fold',
                'benefit': 'Soothes nervous system, aids digestion',
                'energy': 'Introspective and grounding',
                'imagePath': '/images/yoga/paschimottanasana.jpg'
            },
            {
                'name': 'Sukhasana with Pranayama',
                'description': 'Easy seated pose with slow breathing',
                'benefit': 'Regulates breath, calms anxiety',
                'energy': 'Meditative and stabilizing',
                'imagePath': '/images/yoga/sukhasana.jpg'
            }
        ]
        
        recommendations['lifestyle_tips'] = [
            'Establish strict daily routine - wake, eat, and sleep at same times',
            'Practice daily oil massage (Abhyanga) with warm sesame oil',
            'Avoid excessive travel, noise, and overstimulation',
            'Create warm, cozy living environment',
            'Limit screen time, especially before bed',
            'Engage in gentle, grounding exercises (no intense cardio)',
            'Spend time in nature, practice earthing (barefoot walking)',
        ...
        recommendations['stress_management'] = [
            ...
            'Journaling to organize scattered thoughts',
            'Spend 20 minutes in nature daily',
            'Avoid stimulating news and social media',
    ...
    # HIGH VATA (40-60%)
        ...
        recommendations['digestive_analysis'] = "Variable appetite and digestion with tendency toward gas and bloating. Benefit from regular meal times and warm, cooked foods that are easy to digest."
        
        recommendations['sleep_analysis'] = "Sleep quality may be inconsistent. You benefit from calming evening routine and avoiding stimulation before bed. May wake during Vata hours (2-6 AM)."
        ...
        recommendations['herbs'] = [
            'Ashwagandha - calming and nourishing',
            'Ginger - digestive warmth',
            'Cardamom - warming and settling'
        ]
    ...
    # EXTREME PITTA (>60%)
        ...
        recommendations['physical_analysis'] = "Your constitution shows extreme Pitta dominance, indicating significant internal heat and metabolic intensity. You may experience inflammatory conditions, acidity, skin sensitivity, premature greying, and strong body heat. Your body craves cooling, calming, and soothing influences."
        
        recommendations['emotional_analysis'] = "High Pitta creates intense drive, perfectionism, irritability, anger, and impatience. You may be highly critical of self and others, competitive, and struggle with letting go. Sharp intellect but prone to burnout. Need practices that cool emotional intensity."
        
        recommendations['digestive_analysis'] = "Strong, sharp appetite with tendency toward acidity, heartburn, loose stools, and inflammatory gut conditions. Your digestive fire (Agni) is intense and burns hot. You need cooling foods and to avoid spicy, acidic, or fermented foods."
        
        recommendations['sleep_analysis'] = "Moderate sleep needs but may struggle with falling asleep due to mental intensity. Dreams may be vivid, intense, or disturbing. Wake during Pitta hours (10 PM-2 AM) if stressed. Need cooling evening routine."
        
        recommendations['foods_prefer'] = [
            'Cooling cucumbers and melons',
            'Sweet fruits (grapes, pears, apples)',
        ...
        recommendations['foods_avoid'] = [
            ...
            'Sour foods (yogurt, vinegar, citrus)',
            'Fermented foods',
            'Red meat',
            'Alcohol',
        ...
        recommendations['herbs'] = [
            'Brahmi - cools mind and supports clarity',
            'Shatavari - cooling and soothing',
            'Neem - blood purifying and cooling',
            'Amalaki - cooling digestive support',
            'Coriander - cooling and digestive'
        ]
        
        recommendations['drinks'] = [
            'Coconut water',
            'Mint tea (cool or room temperature)',
            'Coriander tea',
            'Aloe vera juice',
            'Rose water drinks',
            'Fennel tea'
        ...
        recommendations['yoga'] = [
            {
                ...
                'description': 'Cooling flow sequence',
                'benefit': 'Reduces internal heat and calms fiery energy',
                'energy': 'Cooling and receptive',
                'imagePath': '/images/yoga/chandra-namaskar.jpg'
            },
            {
                'name': 'Matsyasana (Fish Pose)',
                'description': 'Heart-opening backbend',
                'benefit': 'Releases tension and opens to compassion',
                'energy': 'Heart-centered and cooling',
                'imagePath': '/images/yoga/matsyasana.jpg'
            },
            {
                'name': 'Shavasana (Corpse Pose)',
                'description': 'Complete relaxation pose',
                'benefit': 'Deep cooling relaxation, releases perfectionism',
                'energy': 'Surrendering and peaceful',
                'imagePath': '/images/yoga/shavasana.jpg'
            },
            {
                'name': 'Ardha Matsyendrasana (Seated Twist)',
                'description': 'Gentle spinal twist',
                'benefit': 'Detoxifies liver and cools digestive system',
                'energy': 'Cleansing and balancing',
                'imagePath': '/images/yoga/ardha-matsyendrasana.jpg'
            },
            {
                'name': 'Sitali Pranayama (Cooling Breath)',
                'description': 'Tongue-rolled breathing technique',
                'benefit': 'Directly cools body temperature and mind',
                'energy': 'Intensely cooling',
                'imagePath': '/images/yoga/sitali.jpg'
            }
        ]
        
        recommendations['lifestyle_tips'] = [
            'Avoid excessive heat - stay in cool environments',
            'Practice moderation in all activities (avoid overworking)',
            'Engage in cooling activities like swimming',
            'Avoid competitive situations and arguments',
            'Practice patience and compassion toward self and others',
            'Take regular breaks from work and intensity',
            'Spend time near water (ocean, lakes, rivers)',
        ...
        recommendations['stress_management'] = [
            ...
            'Practice forgiveness and letting go exercises',
            'Engage in creative pursuits without judgment',
            'Avoid checking emails or work late at night',
            'Practice compassion meditation (Metta)',
            'Take cooling walks in nature during evening'
        ]
    ...
    # HIGH PITTA (40-60%)
        ...
        recommendations['digestive_analysis'] = "Strong appetite with tendency toward acidity and heat in digestion. Benefit from cooling foods and avoiding spicy, sour, or fermented items."
        
        recommendations['sleep_analysis'] = "Generally good sleep but may struggle when stressed or overheated. Benefit from cool sleeping environment and calming evening routine."
    ...
    # EXTREME KAPHA (>60%)
        ...
        recommendations['physical_analysis'] = "Your constitution shows extreme Kapha dominance, indicating significant tendency toward heaviness, congestion, and sluggish metabolism. You may experience weight gain, water retention, excess mucus, lethargy, and slow digestion. Your body craves stimulation, movement, and lightness."
        
        recommendations['emotional_analysis'] = "High Kapha creates attachment, resistance to change, depression, lethargy, and emotional heaviness. You may struggle with motivation, oversleep, and resist new experiences. Stable and loyal but can become stuck. Need practices that energize and inspire."
        
        recommendations['digestive_analysis'] = "Slow, heavy digestion with tendency toward weight gain, sluggish metabolism, and mucus formation. Your digestive fire (Agni) is weak and slow. You need light, warm, stimulating foods and may benefit from occasional fasting."
        
        recommendations['sleep_analysis'] = "Heavy, prolonged sleep with difficulty waking. You may oversleep, nap during day, and still feel groggy. Sleep more than 8 hours worsens Kapha. Need energizing morning routine and avoid daytime sleep."
        
        recommendations['foods_prefer'] = [
            'Light, warm, dry foods',
            'Pungent spices (ginger, black pepper, cayenne)',
            'Bitter vegetables (kale, dandelion, arugula)',
            'Astringent foods (beans, lentils, pomegranate)',
            'Apples and pears',
            'Barley and millet',
            'Small amounts of honey (raw, unheated)',
            'Garlic and onions',
        ...
        recommendations['foods_avoid'] = [
            'Heavy, oily foods',
            'Dairy (especially cheese, ice cream, yogurt)',
        ...
        recommendations['herbs'] = [
            'Trikatu - powerful digestive stimulant (ginger, black pepper, long pepper)',
            'Guggul - supports metabolism and weight management',
            'Punarnava - reduces water retention',
            'Chitrak - kindles digestive fire',
            'Tulsi - energizing and clearing'
        ]
        
        recommendations['drinks'] = [
            'Strong ginger tea',
            'Black pepper and honey in warm water (morning)',
            'Tulsi (holy basil) tea',
            'Cinnamon tea',
            'Warm water with lemon and cayenne',
            'CCF tea (cumin, coriander, fennel) - stimulating blend'
        ]
        ...
        recommendations['yoga'] = [
            {
                ...
                'benefit': 'Burns Kapha, generates heat, energizes entire body',
                'energy': 'Highly energizing and warming',
                'imagePath': '/images/yoga/surya-namaskar.jpg'
            },
            {
                'name': 'Virabhadrasana (Warrior Poses)',
                'description': 'Standing strength poses',
                'benefit': 'Builds stamina, confidence, and burns calories',
                'energy': 'Empowering and heating',
                'imagePath': '/images/yoga/virabhadrasana.jpg'
            },
            {
                'name': 'Utkatasana (Chair Pose)',
                'description': 'Challenging standing pose',
                'benefit': 'Strengthens legs, boosts metabolism',
                'energy': 'Intense and energizing',
                'imagePath': '/images/yoga/utkatasana.jpg'
            },
            {
                'name': 'Navasana (Boat Pose)',
                'description': 'Core strengthening pose',
                'benefit': 'Ignites digestive fire, strengthens core',
                'energy': 'Challenging and activating',
                'imagePath': '/images/yoga/navasana.jpg'
            },
            {
                'name': 'Kapalbhati Pranayama',
                'description': 'Forceful exhalation breath',
        ...
        recommendations['lifestyle_tips'] = [
            'Wake up before 6 AM (before Kapha time increases)',
            'Engage in vigorous daily exercise - minimum 45 minutes',
            'Avoid daytime napping entirely',
            'Seek novelty, variety, and new experiences regularly',
        ...
        recommendations['stress_management'] = [
            'Practice Kapalabhati (skull-shining breath) - 5 minutes morning',
            'Engage in dynamic, moving meditation',
            'Take on new challenges to break routine',
            'Practice non-attachment exercises',
            'Vigorous outdoor activities',
            'Social engagement and stimulating conversations',
            'Avoid comfort eating - address emotions directly'
        ]
    ...
    # HIGH KAPHA (40-60%)
        ...
        recommendations['digestive_analysis'] = "Slow, steady digestion with tendency toward sluggish metabolism. Benefit from light, warm, spiced foods and regular exercise to stimulate digestion."
        
        recommendations['sleep_analysis'] = "Deep, heavy sleep with tendency to oversleep. You wake refreshed but may struggle to get out of bed. Benefit from consistent early wake time."
...
def calculate_wellness_score(percentages, symptoms):
    ...
    # Deduct for symptoms (5 points per symptom)
